...
has_return = [0x02, 0x03, 0x04, 0x09, 0x10, 0x11, 0x12, 0x13, 0x1c, 0x18, 0x19, 0x20, 0x23, 0x27, 0x29, 0x2A, 0x2B,
              0x35, 0x4A, 0x4B, 0x4C, 0x4D,
              0x50, 0x51, 0x56, 0x57, 0x59, 0x5A, 0x62, 0x82, 0x84, 0x86, 0x88, 0x8A, 0xA1, 0xA2, 0xB2, 0xB3, 0xB4,
              0xB5, 0xB7, 0xD6, 0xe1, 0xe2, 0xe4]
    ...
    for i in ifname:
        try:
            ...
            HOST = socket.inet_ntoa(
                fcntl.ioctl(s.fileno(), 0x8915, struct.pack('256s', bytes(i, encoding="utf8")))[20:24])
            PORT = 9000
            if i == "wlan0":
